...
form.addEventListener("input", (0, _lodashThrottleDefault.default)(onInput, 1000));
...
function onSubmit(event) {
    ...
    const { elements: { email: email1 , message: message1  } ,  } = event.currentTarget;
    if (email1.value === "" || message1.value === "") return console.log("Please fill in all the fields!");
    console.log(`{email: ${email1.value}, message: ${message1.value}}`);
